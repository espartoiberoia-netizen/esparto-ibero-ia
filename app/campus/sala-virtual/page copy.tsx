...
const TELEGRAM_URL = process.env.NEXT_PUBLIC_TELEGRAM_GROUP_URL;
      ...
      <section className="rounded-xl border border-[#E9E1D8] bg-[#F5EFE7] p-4 space-y-4">
        ...
        <div className="space-y-2">
          ...
          <p className="text-sm text-neutral-700">
            ...
            directo por Zoom. De momento, cuando haya sesión te avisaré por el
            propio grupo de Telegram.
          </p>
          <p className="text-xs text-neutral-500">
            Cuando el enlace esté activo se abrirá en una nueva pestaña de tu
            navegador.
          </p>
        </div>
      </section>
